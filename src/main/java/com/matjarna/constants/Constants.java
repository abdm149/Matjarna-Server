package com.matjarna.constants;

import java.util.HashMap;
import java.util.Map;

public class Constants {
	public static final String[] LANGUAGES = { "ar", "en" };

	public static final String DATE_FORMAT = "dd/MM/yyyy";

	public static final Map<String, String> CURRENCY_MAP = new HashMap<>();

	public static final String[] COUNTRY_CODE = { "AF", "AX", "AL", "DZ", "AS", "AD", "AO", "AI", "AQ", "AG", "AR",
	...
	public static final String REGEXP_PASSWORD = "^(?=.*[0-9])(?=.*[a-zA-Z]).{6,}$";
	static {
		// For now these two will be supported
